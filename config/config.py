...
BOT_TOKEN = getenv("BOT_TOKEN" "5706769951:AAHE8YeRKbcEC2rk1jNu5il7eG2jmbUwtQo")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001848895379"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME" "Laksh")
